...
const (
	UserNameIndex           = "auth.cloudweavhci.io/user-username-index"
	RbByRoleAndSubjectIndex = "auth.cloudweavhci.io/crb-by-role-and-subject"
	PVCByVMIndex            = "cloudweavhci.io/pvc-by-vm-index"
	VMByNetworkIndex        = "vm.cloudweavhci.io/vm-by-network"
)
