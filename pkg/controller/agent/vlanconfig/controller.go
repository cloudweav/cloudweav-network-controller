...
import (
	...
	"github.com/cloudweav/cloudweav-network-controller/pkg/apis/network.cloudweavhci.io"
	...
	"github.com/cloudweav/cloudweav-network-controller/pkg/network/iface"
	"github.com/cloudweav/cloudweav-network-controller/pkg/network/vlan"
	"github.com/cloudweav/cloudweav-network-controller/pkg/utils"
)

const (
	ControllerName = "cloudweav-network-vlanconfig-controller"
