...
import (
	...
	"github.com/cloudweav/cloudweav-network-controller/pkg/network/monitor"
)

const (
	controllerName = "cloudweav-network-link-monitor-controller"
)
...
func Register(ctx context.Context, management *config.Management) error {
	lms := management.CloudweavNetworkFactory.Network().V1beta1().LinkMonitor()
