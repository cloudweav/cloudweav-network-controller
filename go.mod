module github.com/cloudweav/cloudweav-network-controller
...
require (
	...
	github.com/cloudweav/cloudweav v0.0.2-0.20220704073456-08af3d7c1166
	github.com/cloudweav/webhook v0.1.2
